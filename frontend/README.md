...
| Module                                                     | Scope                                                                                                                                                                    | State                                                       |
| ---------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ----------------------------------------------------------- |
| **Auth**                                                   | Two-step sign-in: identifier (email or 10-digit mobile, detected live) → password. Routes by role via `ROLE_HOME`. Route guards, `/auth/me` session and 401 handling     | Built against the API, sign-out included                    |
